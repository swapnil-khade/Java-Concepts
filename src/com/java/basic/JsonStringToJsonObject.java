 ...
 * 
 * String s = "1, -2,3,4,5"; s = s.replaceAll("\\s", ""); List<String> myList =
 * new ArrayList<String>(Arrays.asList(s.split(","))); List<Long> l = new
 * ArrayList<Long>();
 * 
 * for(String s1 : myList) { l.add(Long.valueOf(s1)); } System.out.println(l); }
 * 
 * }
 */