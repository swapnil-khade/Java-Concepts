...
public class MapImpl {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Book b2 = new Book(102, "AAA2", 122, 128);
		...
		System.out.println(hmap.get(b1));
		
		Hashtable<Book ,String> htable = new Hashtable<Book, String>();
		//htable.put(null, "Swapnil"); 												//NullPointerException
		...
		System.out.println("After adding null key----------------------------------");
		System.out.println(hmap.size() +" Size --> Hashmap");
		System.out.println(whmap.size()+" Size --> WeakHashmap");
