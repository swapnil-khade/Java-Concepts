...
public class TreeSetImpl {
	...
	public static void main(String[] args) {
		...
		//ORDER --> ASC/DESC --> homogeneous elements are required.					Comparable or Comparator is mandatory for TreeSet.
		TreeSet<Integer> number3 = new TreeSet<Integer>();
		number3.add(10);
		number3.add(10);
		number3.add(-10);
		//number3.add(null);																	java.lang.NullPointerException
		number3.add(1909);
		number3.add(1320);
		...
		TreeSet<Integer> values =new TreeSet<Integer>(viter);		// TreeMap<Key,Value>
		values.add(192);											// if we pass comparator-- then comparable will not be considered
		values.add(12);
		values.add(92);
		values.add(122);
		values.add(1222);
		...
		System.out.println(books); // it wont works --reason - where is the comparable ???       java.lang.ClassCastException
